...
var cmanOM_VAR: any    = {};
var cmanOM_Obj: any[]    = [];
var cmanOM_OyaObj: any[] = [];

// =========================================================================================
//	初期処理（オンロード時）
// =========================================================================================
export function cmanOM_JS_init(){
	...
	for(var i = 0; i < wTargetTag.length; i++){
		...
		var wHtmlCollection: HTMLCollectionOf<Element> = document.getElementsByTagName(wTargetTag[i]);
	...
	for(var i = 0; i < cmanOM_Obj.length; i++){
		...
		if(cmanOM_Obj[i].style.position.toLowerCase() != 'absolute'){
			...
			(document.getElementById("cmanOM_ID_DMY"+i) as HTMLElement).appendChild(wCopyNode); 
...
//	マウス DOWN
// =========================================================================================
function cmanOM_JS_mdown(e: any){
...
//	マウスMOVE
// =========================================================================================
function cmanOM_JS_mmove(e: any){
